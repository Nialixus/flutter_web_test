...
class HomePageThree extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Consumer<Go>(
          builder: (_, go, ___) =>
              FadeIn(visible: go.state[2].onStart, child: ___),
          child: Column(
              ...
              children: [
                const Padding(
                    padding: EdgeInsets.only(bottom: 25), child: preposition),
                IntrinsicHeight(
                    child: Row(
                        mainAxisSize: MainAxisSize.min,
                        mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      Padding(
                          ...
                          child: IntrinsicWidth(
                              child: Column(
                                  children: List.generate(5, (x) => left(x))))),
                      Flexible(
                          child: IntrinsicWidth(
                              child: Column(
                                  children: List.generate(5, (y) => right(y)))))
                    ]))
              ]),
        ));
  }
